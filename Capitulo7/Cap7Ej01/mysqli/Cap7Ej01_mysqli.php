...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Cap7 - Ejercicio 1_mysqli</title>
    ...
    <body>
        ...
        <div id="container">
            <table>
                <form method="post" action="insertCap7Ej01_mysqli.php">
                   <tr>
        ...
        ?>
                    <tr>
                      ...
                      <td><a href="updateCap7Ej01_mysqli.php?dni=<?=$registro->dni?>"<i class="fa fa-pencil"></i></a></td>
                      <td><a href="deleteCap7Ej01_mysqli.php?dni=<?=$registro->dni?>"><i class="fa fa-trash-o"></i></a></td>
                    </tr> 
    <?php
                }
    ?>                    
